            ...
            <div
                ...
                <div
                    ...
                    <svg role="img" class="dark:hidden dark:invert" width="20" viewBox="0 0 24 24"
                        xmlns="http://www.w3.org/2000/svg" aria-labelledby="color-scheme-light">
                        <path
                    ...
                    <svg role="img" class="hidden dark:block dark:invert" width="20" viewBox="0 0 24 24"
                        xmlns="http://www.w3.org/2000/svg" aria-labelledby="color-scheme-dark">
                        <path
...
if (localStorage.getItem("theme") === "dark")
  document.querySelector("#dark-toggle").setAttribute("checked", "checked");
else if (localStorage.getItem("theme") === "light")
  document.querySelector("#dark-toggle").removeAttribute("checked");
